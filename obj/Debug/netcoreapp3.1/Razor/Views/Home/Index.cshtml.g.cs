#pragma checksum "F:\Projects\Task\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bda076b10be94ca3d67fe20d5701d96d34edca03"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bda076b10be94ca3d67fe20d5701d96d34edca03", @"/Views/Home/Index.cshtml")]
        ...
        <div class=""card-body"">
            <div class=""row col-md-12"">
                <div class=""col-md-2"">
                    ...
                    <div>");
#nullable restore
#line 124 "F:\Projects\Task\Views\Home\Index.cshtml"
...
#nullable restore
#line 129 "F:\Projects\Task\Views\Home\Index.cshtml"
...
#nullable restore
#line 134 "F:\Projects\Task\Views\Home\Index.cshtml"
...
<script type=""text/javascript"">
    ...
    function prepareBankData(data) {
        data.forEach((value, index) => {
  ");
            WriteLiteral(@"          if (bankData && bankData.filter(x => x.BankName == value.BankName).length <= 0) {
                bankData.push(value)
            } else {
    ...
    function areaChart(data) {
        ...
        svg.selectAll("".dot"")
            ...
            .attr(""r"", 5)
         ");
            WriteLiteral(@"   .on(""mouseover"", function (d) {
                div.transition()
                    .duration(200)
                    .style(""opacity"", .9);
    ...
    function barChart(data) {
        ...
        svg.append(""g"")
            .at");
            WriteLiteral(@"tr(""transform"", ""translate(0,"" + height + "")"")
    ...
    function donutChart(data) {
       ...
       ");
            WriteLiteral(@" var color = d3.scaleOrdinal(d3.schemeCategory20);
        ...
        svg.append(");
            WriteLiteral(@"'g').classed('lines', true);
    ...
    function donutChartLabels(data) {
        ...
        va");
            WriteLiteral(@"r pie = d3.pie()
            .sort(null)
            .value(function (d) { return +d.BankBalanceAmount; });
