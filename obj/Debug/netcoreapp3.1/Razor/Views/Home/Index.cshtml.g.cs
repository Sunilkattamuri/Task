#pragma checksum "F:\Projects\Task\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "263d47bd3a72d20461896dfb4350cfeb144a8252"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"263d47bd3a72d20461896dfb4350cfeb144a8252", @"/Views/Home/Index.cshtml")]
...
<script type=""text/javascript"">
    ...
    $(document).ready(function () {
        ...
        $.getJSON(""json/data.json"", function (data) {
            completeData = data;
            chartData = data.Sheet1.filt");
            WriteLiteral(@"er(x => x.Division == ""Division 2"" && x.Currency == ""INR"");
    ...
    function prepareCompanyData(data) {
        ...
        data.forEach((value, index) => {
            if (comapanyData &&");
            WriteLiteral(@" comapanyData.filter(x => x.EntityId == value.EntityId).length <= 0) {
    ...
    function areaChart(data) {
        ...
        var parseT");
            WriteLiteral(@"ime = d3.timeParse(""%m/%d/%y"");
        ...
        x.dom");
            WriteLiteral(@"ain(d3.extent(data, function (d) { return d.date; }));
   ...
   ");
            WriteLiteral(@"     //var data = [26, 25, 10, 30, 30, 50, 33, 56, 38];
